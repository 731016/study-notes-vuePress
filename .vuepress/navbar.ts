...
export default [
  ...
  },
  {
    ...
    children: [
      ...
      {
        text: "HTML+CSS+JS+JQuery案例学习",
        link: "https://github.com/731016/webpage-basic-learning",
      },
  ...
  },
  {
    text: "vscode插件",
    collapsible: true,
    children: [{ text: "vscode插件", link: "/开发环境/vscode.html" }],
  },
  {
    text: "演示网站",
    collapsible: true,
    children: [
      {
        text: "基于vue的快递代取系统【毕业设计】",
        link: "http://119.3.104.52:8080/",
      },
    ],
  },
] as NavbarConfig;
